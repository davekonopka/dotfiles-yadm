...
alias gbmerged='git branch --merged $(git_main_branch) | grep -v $(git_main_branch) | sed "'"s/[ ]*//"'"'
alias gbgone='git branch -vv | awk '\''/: gone]/{print $1}'\'
alias gbstale='git fetch -p >/dev/null 2>&1 && { gbgone; gbmerged; } 2>&1'
